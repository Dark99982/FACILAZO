...
import { NetworkField } from "./motion/NetworkField";
...
export function ProductLines() {
  ...
  return (
    <section id="soluciones" className="relative overflow-hidden py-24">
      <NetworkField nodes={productLines.length} />

      <SceneReveal className="mx-auto max-w-2xl px-4 text-center sm:px-6">
        ...
        <HorizontalRail className="px-4 sm:px-6 lg:px-[8vw]">
          {productLines.map((line, index) => {
            ...
            return (
              ...
              >
                <div
                  data-cursor={locale === "en" ? "View" : "Ver"}
